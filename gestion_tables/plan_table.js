...
function range(data_reservation /* id: str, nom: str, nb_pers:int */){
...
data_test = [
  { "id" : "1", "nom": "Jojo", "nb_pers": 1},
  { "id" : "2", "nom": "Lelolelolelo", "nb_pers": 4},
  { "id" : "3", "nom": "oMyGawd", "nb_pers": 5},
  { "id" : "4", "nom": "Yareyare", "nb_pers": 8},
  { "id" : "5", "nom": "Daze", "nb_pers": 1},
];


let resto = range(data_test);
