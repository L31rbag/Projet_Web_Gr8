      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="form-ligne">
          <div class="form-g">
            ...
            <input v-model="form.personne" id="personne" type="number" min="1" max="8" class="input" required />
          </div>
        ...
        <button type="submit" class="resa">Réserver</button>
      </form>
    </div>
  </template>
